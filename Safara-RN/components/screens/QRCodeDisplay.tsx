...
//   // ✅ STORE TOURIST ID IN LOCALSTORAGE
//   useEffect(() => {
//     const storeTouristId = async () => {
//       try {
//         await AsyncStorage.setItem(
//           `tourist_id:${touristId.id}`,
//           JSON.stringify(touristId)
//         );
//         console.log("✅ Stored Tourist ID:", touristId.id);
//       } catch (error) {
...
//       <View style={styles.qrCard}>
//         <QRCode
//           value={`safara://tourist/${touristId.id}`} // ✅ DEEP LINK FORMAT
//           size={220}
//           backgroundColor="white"
//           color="black"
//           getRef={(c) => (qrRef.current = c)}
